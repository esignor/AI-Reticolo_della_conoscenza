...
\textbf{UC\_g.2: Visualizzazione messaggio di errore di mancata idoneità del browser in uso}\mbox{}
...
\begin{itemize}
\item \textbf{V}: Identifica un requisito di Vincolo, ovvero descrive servizi o funzioni offerti dal sistema;
\item \textbf{F}: Identifica un requisito Funzionale, ovvero descrive vincoli sui servizi offerti dal sistema; ;
...
\begin{table}
\caption{Tabella dei requisiti}\label{tab:requisiti}
\begin{tabularx}{\textwidth}{|c|c|X|}
	...
	\textbf{Codice} & \textbf{Descrizione)} & \textbf{Stato} \\\hline
	   ...
	   ROF1.2 & L'utente pu\`o caricare i dati nell'applicativo della Rete mediante l'uso di file in formato  comma-separated values (csv) & Completato  \\	
	    ...
	    \hline
	    RDF3 & L'utente pu\`o salvare i dati addestrati della Rete & Completato \\
	    \hline
	    RDF4 & L'utente pu\`o visualizzare i dati addestrati della Rete salvati in formato JSON & Completato \\
	    \hline
	    RDF5 & L'utente pu\`o visualizzare i dati inseriti della Rete e su cui effettuare la previsione & Completato \\
	    RFF5.1 & L'utente visualizza i dati inseriti della Rete all'interno nella textarea dedicata dell'applicativo & Completato \\
	    RFF5.2 & L'utente pu\`o visualizzare i dati inseriti nella Rete  su una pagina secondaria reindirizzata dall'applicativo & Completato \\
	   \hline
	   RFF6 & L'utente pu\`o effettuare la cancellazione dello storico delle operazioni eseguite & Completato \\
    \hline
    RFF6 & L'utente pu\`o effettuare la cancellazione dello storico delle operazioni eseguite & Completato \\
    \hline
    RDF6 & L'utente pu\`o effettuare l'inserimento dei parametri di clusterizzazione sui dati addestrati della Rete & Completato \\
    RDF6.1 & L'utente pu\`o effettuare l'inserimento del primo parametro di differenziale di accoppiamento per effettuare la clusterizzazione delle domande  & Completato \\
   RDF6.2 & L'utente pu\`o effettuare l'inserimento del secondo parametro di differenziale di accoppiamento per effettuare la clusterizzazione delle domande  & Completato \\
    RDF6.3 & L'utente pu\`o effettuare l'inserimento del secondo parametro di differenziale di accoppiamento per effettuare la clusterizzazione delle domande  & Completato \\
    \hline
     ROF7 & L'utente pu\`o effettuare del vettore previsione su cui effettuare la previsione sui dati addestrati della Rete  & Completato \\
    \hline
    ROF8 & L'utente visualizza il valore delle previsioni ottenute dalla Rete nella textarea dedicata & Completato \\
    \hline 
    RFF9 & L'utente visualizza il valore delle previsioni espresse in termini RGB colours ottenute dalla Rete nella textarea dedicata & Completato \\
    RFF10 & L'utente visualizza la clusterizzazione delle domande ottenuta dai parametri di differenziale di accoppiamento ottenute dalla Rete nella textarea dedicata & Completato \\
    \hline 
