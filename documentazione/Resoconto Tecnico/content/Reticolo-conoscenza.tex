...
\end{itemize}
.
\paragraph{Prima architettura: layers(12, 12}
...
\begin{figure}[H]
\centering
	\includegraphics[width=0.60\linewidth]{./image/collage_reticolo-logica(12,12).png}
...
\end{longtable}
\noindent
Le domande correlate tra i gruppi (mhaimflmrt, xnyfhvvlzx), (ccsofpywab, kzorhoohrb) e (fbekkymdja, kkhcmynavp) non presentano alcuna somiglianza di tematica. Riducendo la correlazione tra i cluster si generano 2 cluster ma non rispettano la differenziazione tra domande di serie numeriche e eulero venn.
