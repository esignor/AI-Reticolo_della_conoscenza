...
df_numeric<-read.table("/home/eleonora/Scrivania/AI-Reticolo_della_conoscenza/trainset dati/previsioni_generatorinputpure.csv", header=FALSE, sep=",")  # carico il file csv
