...
library("factoextra")
df<-read.table("/home/eleonora/Scrivania/AI-Reticolo_della_conoscenza/PCA/trainset dati/set-db.csv", header=FALSE, sep=",")  # carico il file csv
...
fviz_contrib(res.pca, choice = "var", axes = 1:60, top = 10)
